...
class VehicleBase {
  ...
  public:
    ...
    static Eigen::Matrix<double, 2, 5> get_box2d(const State& tar_offset) {
        ...
        vehicle << -VehicleBase::length / 2, VehicleBase::length / 2, VehicleBase::length / 2,
            -VehicleBase::length / 2, -VehicleBase::length / 2, VehicleBase::width / 2,
    ...
    static Eigen::Matrix<double, 2, 5> get_safezone(const State& tar_offset) {
        ...
        safezone << -VehicleBase::safe_length / 2, VehicleBase::safe_length / 2,
            ...
            -VehicleBase::safe_length / 2, VehicleBase::safe_width / 2, VehicleBase::safe_width / 2,
